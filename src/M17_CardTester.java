/**
 * This is a class that tests the M17_Card class.
 *
 *  @author Lydia Chung
 *  @version 06/07/2019
 */

public class M17_CardTester
{
   /**
   ...
   public static void main(String[] args) {
      ...
      // Establish new cards
      M17_Card aceHearts = new M17_Card("ace", "hearts", 1);
      M17_Card sixSpades = new M17_Card("six", "spades", 6);
      M17_Card jackDiamonds = new M17_Card("jack", "diamonds", 11);
